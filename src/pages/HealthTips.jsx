                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="max-w-4xl">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="px-3 py-1 bg-primary-light text-primary-green text-xs font-black uppercase tracking-widest rounded-[4px]">Verified Articles</span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 leading-tight">
                            Health Tips & <span className="text-primary-green">Professional Advice</span>
                        </h1>
                        ...
                        <div className="relative max-w-xl">
                            ...
                            <input
                                type="text"
                                className="block w-full pl-11 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-[4px] focus:ring-2 focus:ring-primary-light focus:border-primary-green outline-none transition-all text-gray-700 font-medium"
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="flex justify-between items-center mb-10">
                    <h2 className="text-xl font-black text-gray-800 uppercase tracking-widest flex items-center gap-2">
                        <TrendingUp size={20} className="text-primary-green" /> Latest Insights
                    </h2>
                        ...
                        >
                            ...
                            <div className="relative aspect-[16/9] overflow-hidden">
                                ...
                                <div className="absolute top-4 right-4 px-3 py-1 bg-white/90 backdrop-blur-sm rounded-[4px] text-[10px] font-black uppercase tracking-wider shadow-sm flex items-center gap-1">
                                    <Clock size={12} className="text-primary-green" /> 5 min read
                                </div>
                            </div>
                            ...
                            <div className="p-6 flex-grow flex flex-col">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-primary-green transition-colors line-clamp-2 leading-snug">
                                    {tip.title}
                                </h3>
                                ...
                                <div className="mt-auto pt-6 border-t border-gray-50 flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        <div className="w-8 h-8 rounded-full bg-primary-light flex items-center justify-center text-primary-green">
                                            <User size={14} />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex items-center gap-1 text-primary-green font-black text-xs uppercase tracking-widest group-hover:gap-2 transition-all">
                ...
                {filteredTips.length === 0 && (
                    <div className="text-center py-20 bg-white rounded-[4px] border border-dashed border-gray-200">
                        ...
                        <button onClick={() => setSearch('')} className="mt-4 text-primary-green font-bold underline">Clear filters</button>
                    </div>
                )}
            </div>
        </div>
