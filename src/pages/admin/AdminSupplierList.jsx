...
const AdminSupplierList = () => {
    ...
    const openSupplierDetail = (supplier) => {
        Swal.fire({
            title: `<div class="flex items-center gap-3 text-left"><div class="w-10 h-10 bg-primary-light text-primary-green rounded-xl flex items-center justify-center font-bold">${supplier.name.substring(0,1)}</div><div class="text-xl font-bold">${supplier.name}</div></div>`,
            html: `
                <div class="text-left mt-4 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-primary-light p-4 rounded-xl border border-primary-green/20 flex flex-col items-center justify-center">
                            <span class="text-2xl font-black text-primary-green">${supplier.products_count || 0}</span>
        ...
        <div className="space-y-6 pt-2 pb-8 max-w-[1500px] mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div className="bg-white rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] p-6 flex justify-between items-start border border-gray-100">
                    ...
                    <div className="bg-primary-light p-3 rounded text-primary-green">
                        <Truck size={28} />
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] p-6 flex justify-between items-start border border-gray-100">
                    ...
                    <div className="bg-primary-light p-3 rounded text-primary-green opacity-80">
                        <Package size={28} />
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] p-6 flex justify-between items-start border border-gray-100">
                    ...
                    <div className="bg-accent-green/10 p-3 rounded text-accent-green">
            ...
            <div className="bg-white rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100 overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center p-6 gap-4 border-b border-gray-100">
                    ...
                    <div className="flex gap-3 w-full md:w-auto">
                        <div className="relative flex w-full md:w-64 rounded overflow-hidden border border-gray-200 focus-within:border-primary-green focus-within:ring-2 focus-within:ring-primary-green/30 transition-all text-gray-600 group">
                            <Search size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-primary-green" />
                            <input 
                                type="text" 
                                    ...
                                    <td className="py-4 px-6">
                                        <div className="flex items-center justify-center gap-2">
                                            <button 
                                                ...
                                                className="p-1.5 border border-primary-green/30 text-primary-green hover:bg-primary-green hover:text-white rounded transition-colors bg-white hover:shadow-md"
                                                title="View"
                                            >
                                                <Eye size={16} />
                                            </button>
                                            <button 
                                                ...
                                                className="p-1.5 border border-accent-green/30 text-accent-green hover:bg-accent-green hover:text-white rounded transition-colors bg-white hover:shadow-md"
                                                title="Edit"
                                            >
                                                <Edit size={16} />
                                            </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-6">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 object-cover hover:shadow-md transition-shadow cursor-pointer group">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="bg-primary-light p-3 rounded text-primary-green group-hover:bg-primary-green group-hover:text-white transition-colors">
                            <Package size={20} />
                        </div>
                        <div>
...
const ListIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-primary-green"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>
);
