                            ...
                            <div className="flex flex-col items-center">
                                ...
                                {profileFile && (
                                    <button 
                                        ...
                                        className="mt-3 flex items-center gap-1.5 text-xs font-bold text-primary-green hover:text-primary-dark bg-primary-light hover:bg-primary-green/20 px-3 py-1.5 rounded-full transition-all"
                                    >
                                        {isUploadingPhoto ? (
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
                        <div className="p-6 border-b border-slate-50 flex items-center gap-3">
                            <div className="w-10 h-10 rounded-2xl bg-primary-light flex items-center justify-center text-primary-green">
                                <UserCircle size={20} />
                            </div>
