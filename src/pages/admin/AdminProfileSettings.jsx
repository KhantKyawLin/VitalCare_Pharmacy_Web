            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden sticky top-24">
                        <div className="h-24 bg-gradient-to-r from-[#8DB600] to-[#769900]"></div>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="relative group">
                                    <div className="w-24 h-24 rounded-full bg-white p-1 shadow-lg overflow-hidden">
                                        <div className="w-full h-full rounded-full bg-slate-100 flex items-center justify-center text-[#8DB600] overflow-hidden">
                                            {profilePreview ? (
                                    ...
                                    {/* Online dot */}
                                    <div className="absolute bottom-1 right-1 w-5 h-5 bg-[#8DB600] border-2 border-white rounded-full flex items-center justify-center z-10 shadow-sm">
                                ...
                                {profileFile && (
                                    <button 
                                        ...
                                        className="mt-3 flex items-center gap-1.5 text-xs font-bold text-[#8DB600] hover:text-[#769900] bg-[#8DB600]/10 hover:bg-[#8DB600]/20 px-3 py-1.5 rounded-full transition-all"
                                    >
                                        {isUploadingPhoto ? (
                                            <div className="w-3.5 h-3.5 border-2 border-[#8DB600]/30 border-t-[#8DB600] rounded-full animate-spin"></div>
                                        ) : (
                                            <Upload size={14} />
                                        )}
                                        Save Photo
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
                        <div className="p-6 border-b border-slate-50 flex items-center gap-3">
                            <div className="w-10 h-10 rounded-2xl bg-[#8DB600]/10 flex items-center justify-center text-[#8DB600]">
                                <UserCircle size={20} />
                            </div>
                        ...
                        <form onSubmit={updateProfile} className="p-6 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#8DB600]/20 focus:border-[#8DB600] transition-all"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        onChange={handleProfileChange}
                                        className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#8DB600]/20 focus:border-[#8DB600] transition-all"
                                    >
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-slate-500 uppercase ml-1">Work/Home Address</label>
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleProfileChange}
                                        className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#8DB600]/20 focus:border-[#8DB600] transition-all resize-none"
                            ...
                            <div className="flex justify-end pt-2">
                                <button
                                    ...
                                    className="flex items-center gap-2 bg-[#8DB600] hover:bg-[#769900] text-white px-6 py-2.5 rounded-xl font-bold shadow-lg shadow-[#8DB600]/20 transition-all disabled:opacity-50"
                                >
                                    {isUpdatingProfile ? (
