                ...
                <div className="flex flex-col md:flex-row justify-between items-center px-6 pb-4 gap-4">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="relative customize-columns-dropdown shrink-0">
                            ...
                            {showColumnDropdown && (
                                <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-xl z-50 py-3 animate-in fade-in slide-in-from-top-2 duration-200">
                                    <div className="px-4 pb-2 mb-2 border-b border-gray-100 font-bold text-xs text-gray-400 tracking-wider">
                                        DEFAULT
                                    </div>
                                    <div className="px-2 space-y-0.5 max-h-[60vh] overflow-y-auto">
                                        {[
                                            { id: 'id', label: 'ID' },
                                            ...
                                            <label key={col.id} className="flex items-center px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-50 group">
                                                <div className={`w-4 h-4 rounded border flex items-center justify-center mr-3 transition-colors ${visibleColumns[col.id] ? 'bg-[#0096ff] border-[#0096ff]' : 'border-gray-300 bg-white group-hover:border-[#0096ff]'}`}>
                                                    {visibleColumns[col.id] && <Check size={12} className="text-white" strokeWidth={3}/>}
                                                </div>
                                                <input 
                                                    type="checkbox" 
                                                    className="hidden" 
                                                ...
                                                />
                                                <span className="text-[13.5px] text-gray-700">{col.label}</span>
                                            </label>
                                        ))}
                                    </div>
                                </div>
                                ...
                                return (
                                    <tr key={product.id} className="border-b border-gray-100 last:border-0 hover:bg-gray-50/40 transition-colors group">
                                        ...
                                        {visibleColumns.status && (
                                            <td className="py-3.5">
                                                <span className={`px-3 py-1 rounded text-[11px] font-bold text-white shadow-sm inline-block min-w-[70px] text-center ${
                                                    isLowStock ? 'bg-yellow-500' : 'bg-[#1E8449]'
                                                }`}>
                                                    {statusString}
                                                </span>
                                            </td>
